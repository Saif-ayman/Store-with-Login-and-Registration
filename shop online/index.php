...
<div class="user-profile">
   ...
   <div class="flex">
      <a href="index.php?logout=<?php echo $user_id; ?>" onclick="return confirm('Are you sure to logout ?');" class="delete-btn">Log out  </a>
   </div>
   ...
   <table>
      ...
      ?>
         <tr>
            ...
            <td><a href="index.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn" onclick="return confirm('Delete item from cart ?');">Delete</a></td>
         </tr>
      <?php
      ...
      <tr class="table-bottom">
         ...
         <td><a href="index.php?delete_all" onclick="return confirm('Delete all items ?');" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled'; ?>"> Delete all</a></td>
      </tr>
   </tbody>
   </table>
